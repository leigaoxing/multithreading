...
public class ThreadScopeShareData {
    ...
    static class A {
        public int get() {
            System.out.println("A " + Thread.currentThread().getName() + "has data: " + threadDate.get(Thread.currentThread()));
    ...
    static class B {
        public int get() {
            System.out.println("B " + Thread.currentThread().getName() + "has data: " + threadDate.get(Thread.currentThread()));
            return threadDate.get(Thread.currentThread());
        }
    }
